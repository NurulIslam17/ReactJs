export const question =[
  ...
  },
  {
    ...
    answer:"An event is an action that a user or system may trigger, such as pressing a key, a mouse click, etc. 1) React events are named using camelCase, rather than lowercase in HTML. 2) With JSX, you pass a function as the event handler, rather than a string in HTML"
  },
  {
    id:4,
